...
Para esta prueba trabajaré la capa Bronze desde archivos Parquet generados localmente en `data/source/` y cargados al Lakehouse de Microsoft Fabric en la ruta `Files/source/`.
...
Los archivos esperados en `Files/source/` son:
...
3. Cargar los archivos Parquet locales de `data/source/` en `Files/source/`.
...
- archivos cargados en `Files/source/`;
